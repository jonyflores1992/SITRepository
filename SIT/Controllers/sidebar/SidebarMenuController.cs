...
namespace SIT.Controllers.sidebar
{
    public partial class SidebarController : BaseController
    {
        public IActionResult SidebarMenu()
        {
            ...
            mainMenuItems.Add(new
            {
                ...
                items = new List<object>()
                    {
                        new { text = "All Data", href = "#" },
                        new { text = "Category2", href = "#" },
                        new { text = "Category3", href = "#" }
                    }
            });
            mainMenuItems.Add(new
            {
